...
import { WatchListItemOverview } from './WatchListItemOverview';

const meta = {
    title: 'components/WatchListItemOverview',
    component: WatchListItemOverview,
    parameters: {
        layout: 'centered',
    },
    tags: ['autodocs'],
    argTypes: {},
} satisfies Meta<typeof WatchListItemOverview>;
