...
import { converterActions } from 'features/coin-conveter/model/converterSlice';
import { selectConverterCoinFrom, selectConverterCoinTo } from 'features/coin-conveter/model/selectors';
